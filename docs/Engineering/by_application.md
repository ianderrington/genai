...
??? tip [The Nucleotide Transformer: Building and Evaluating Robust Foundation Models for Human Genomics](https://www.biorxiv.org/content/10.1101/2023.01.11.523679v2.full.pdf) 
    A thorough set of JAX-enabled models for use in downstream uses. They use 6mer tokenization and embeddings, 
