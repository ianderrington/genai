...
## Closed Source
The integrations with closed source systems are myriad. Because interfacing is key, those interfaces that already exist can be augmented with AI to improve the way people work with them.
...
!!! note "[NotesOllama](https://smallest.app/notesollama/) — an OSX Notes integration running on locally-hosted Ollama models."

!!! note "[Obsidian](https://obsidian.md) for markdown allows for numerous [apps](https://obsidian-plugin-stats.vercel.app/) that may contain AI while maintaining a quality interconnected markdown interface."
