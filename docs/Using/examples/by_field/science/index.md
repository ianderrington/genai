...
Like the use of GenAI in other domains, it is essential to consider the [risks](../../../ethically/de-risking/index.md) associated with its application, in this case to Science. 
