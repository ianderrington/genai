...
<div>
??? [UniversalNER](https://arxiv.org/pdf/2308.03279.pdf) "Used ChatGPT to distill much smaller model for a certain domain, for Universal NER models. Cc-by-4-C distribution"
    ```
