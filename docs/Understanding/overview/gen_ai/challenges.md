...
???+ important "Technical challenges with GenAI" technical-challenges-with-genai
    ...
    * Make LLMs generate results more [quickly and cheaply](../../architectures/generation/index.md)
    ...
    * Improving [UI/UX experience](../..building_applicationsfront_end.md) with GenAI
