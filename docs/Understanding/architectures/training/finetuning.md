...
??? abstract "![GitHub Repo stars](https://badgen.net/github/stars/OpenPipe/OpenPipe) [Open Pipe](https://github.com/OpenPipe/OpenPipe) allows you to use powerful but expensive LLMs to fine-tune smaller and cheaper models"
...
## Useful Libraries
!!! abstract "![GitHub Repo stars](https://badgen.net/github/stars/okuvshynov/slowllama) [Slow Llama](https://github.com/okuvshynov/slowllama) for finetuning on a M1/M2 mac"
