...
[^n1]Note: This is different from [recurrent_training](./recurrent_training.md) where a model is used to generate training examples to improve the training of a subsequent model. 
