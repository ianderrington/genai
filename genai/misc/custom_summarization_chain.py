...
def main(args):
    ...
    chunk_size = st.sidebar.slider(
        "Chunk Size", min_value=20, max_value=10000, step=10, value=2000
    )
...
def get_args():
    """Get arguments for the otherwise user inputs above, so we can run the above as a function on those args"""
    import argparse

    parser = argparse.ArgumentParser()
    parser.add_argument("--llm", type=str, default="ChatGPT")
    parser.add_argument("--chain_type", type=str, default="map_reduce")
    parser.add_argument("--chunk_size", type=int, default=2000)
    parser.add_argument("--chunk_overlap", type=int, default=200)
    parser.add_argument("--temperature", type=float, default=0.5)
    parser.add_argument("--num_summaries", type=int, default=1)
    parser.add_argument("--pdf_file_path", type=str, default="")
